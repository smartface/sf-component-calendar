...
(function (RangeSelection) {
    RangeSelection[RangeSelection["IDLE"] = -1] = "IDLE";
    RangeSelection[RangeSelection["STARTED"] = 0] = "STARTED";
    RangeSelection[RangeSelection["COMPLETED"] = 1] = "COMPLETED";
...
function validValueMaybe(value, notvalue) {
    if (notvalue === void 0) { notvalue = null; }
    return !value ?
        notvalue :
        value;
...
function validateRangePoint(point, month) {
    return inSameYear(point, month.date) ?
        validValueMaybe(getDatePos(point, month), notValidRangePoint()) :
        notValidRangePoint();
}
/**
 ...
 * @class
 */
var CalendarCore = /** @class */ (function () {
    ...
    CalendarCore.prototype.init = function () { };
    /**
 ...
 */
    ...
    CalendarCore.prototype.unsubscribe = function (cb) {
        var unload = this.subscribers.find(function (_cb) { return cb != _cb; });
    ...
    CalendarCore.prototype.changeCalendar = function (lang, type, specialDays, firstDayOfWeek) {
        ...
        this._calendarService = CalendarService_1.default({
            lang: lang,
            type: type,
