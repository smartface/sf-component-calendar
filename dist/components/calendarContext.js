...
var StyleContext = require("@smartface/contx/lib/styling/StyleContext");
var getOneProp = require("@smartface/contx/lib/smartface/sfCorePropFactory").default;
var pageContext = require("@smartface/contx/lib/smartface/pageContext");
var fromSFComponent = require("@smartface/contx/lib/smartface/fromSFComponent").default;
var INIT_CONTEXT_ACTION_TYPE = require("../services/Context").INIT_CONTEXT_ACTION_TYPE;
var System = require('sf-core/device/system');
var styler = require("@smartface/styler/lib/styler");
function raiseTargetNotfound(target) {
    return function (message) {
        if (message === void 0) { message = "Component cannot be found."; }
...
function reducer(context, action, target, state) {
    ...
    switch (action.type) {
        case INIT_CONTEXT_ACTION_TYPE:
            newState.days = context.reduce(function (acc, actor, name) {
        ...
        case "deselectDays":
            ...
            return newState;
        case "daySelected":
            var selected = context.find(newState.selectedDay);
            if (selected) {
        ...
        case "changeCalendar":
            context.map(function (actor) {
                ...
                var className = actor.getInitialClassName();
...
function createContext(component, name, styles) {
    if (name === void 0) { name = "calendar"; }
    if (styles === void 0) { styles = {}; }
    var context = pageContext(component, name, reducer);
