...
export default class NewPage001 extends withDismissAndBackButton(
  NewPage001Design
) {
  ...
  constructor(private router?: Router, private route?: Route) {
    ...
    this.calendar.onDaySelect = (res) => {
      ...
      this.children.label2.text =
        date.date.day + "/" + date.date.month + "/" + date.date.year;
      this.children.label2_1.text =
        date.dayInfo.specialDay.length > 0
    ...
    this.children.buttonRange.onPress = () => {
      this.calendar.setRangeDates(
        { day: 21, month: 10, year: 2017 },
